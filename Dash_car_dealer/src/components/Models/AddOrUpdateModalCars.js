...
const AddOrUpdateModalCars = (props) => {
  ...
  useEffect(() => {
    if (props.type === "EDIT") {
      console.log("ediiit price", props?.record?.prices[0]);
      form.setFieldsValue({
        ...props.record,
        day1: props?.record?.prices[0]?.value,
        day2: props?.record?.prices[1]?.value,
        day3: props?.record?.prices[2]?.value,
        day4: props?.record?.prices[3]?.value,
        day5: props?.record?.prices[4]?.value,
        day6: props?.record?.prices[5]?.value,
        day7: props?.record?.prices[6]?.value,
        forfait: props?.record?.prices[7]?.value,
      });
      ...
      await axios
        .put(
          "https://www.ridharentcar.online/api/car/edit/" + values.id,
          {
            ...
            Vin: values.Vin,
            prices: [
              { label: "1", value: values.day1 },
              { label: "2", value: values.day2 },
              { label: "3", value: values.day3 },
              { label: "4", value: values.day4 },
              { label: "5", value: values.day5 },
              { label: "6", value: values.day6 },
              { label: "7", value: values.day7 },
              { label: "+7", value: values.forfait },
            ],
          },
          config
        )
        ...
        >
          ...
          <Row>
            ...
            >
              <Row justify="space-between" gutter={16}>
                ...
                <Col span={12}>
                  <label> Please input Model</label>
                  <Form.Item
                    name="Model"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input Mileage</label>
                  <Form.Item
                    name="Mileage"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input Engine</label>
                  <Form.Item
                    name="Engine"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input Cylinder</label>
                  <Form.Item
                    name="Cylinder"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input Transmission</label>
                  <Form.Item
                    name="Transmission"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input Bodytype</label>
                  <Form.Item
                    name="Bodytype"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input INTERIORCOLOR </label>
                  <Form.Item
                    name="INTERIORCOLOR"
                    rules={[
                      {
                ...
                <Col span={12}>
                  <label> Please input EXTERIORCOLOR </label>
                  <Form.Item
                    name="EXTERIORCOLOR"
                    rules={[
                      {
                ...
                <Col span={24}>
                  <label> Please input Energy </label>
                  <Form.Item
                    name="Energy"
                    rules={[
                      {
                ...
                <Col span={24}>
                  <label> Please input options </label>
                  <Form.Item
                    name="options"
                    rules={[
                      {
                      ...
                      options={[
...

                        {
                          ...
                          options: [
                            ...
                            {
                              label: "Lecteur CD/MP3",
                              value: "Lecteur CD/MP3",
                            },
                            {
                        ...
                        },
                        {
                          ...
                          options: [
                            ...
                            {
                              label: "Protège-caisse",
                              value: "Protège-caisse",
                            },
                            {
...

                        {
                          ...
                          options: [
                            ...
                            {
                              label: "Anti-démarreur",
                              value: "Anti-démarreur",
                            },
          ...
          <Space direction="vertical" size="middle" style={{ display: "flex" }}>
            ...
            >
              <Row>
                <Col span={12}>
                  <label>Price of one day</label>
                  <Form.Item
                    name="day1"
                    rules={[
                      {
                        required: true,
                        message: "Please input your one day price!",
                      },
                    ]}
                  >
                    <Input placeholder="one day price" type="number" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <label>Price of 2 days</label>
                  <Form.Item
                    name="day2"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 2 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 2 days" type="number" />
                  </Form.Item>
                </Col>
              </Row>
              ...
              <Row>
                <Col span={12}>
                  <label>Price of 3 days</label>
                  <Form.Item
                    name="day3"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 3 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 3 days" type="number" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <label>Price of 4 days</label>
                  <Form.Item
                    name="day4"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 4 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 4 days" type="number" />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                <Col span={12}>
                  <label>Price of 5 days</label>
                  <Form.Item
                    name="day5"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 5 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 5 days" type="number" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <label>Price of 6 days</label>
                  <Form.Item
                    name="day6"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 6 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 6 days" type="number" />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                <Col span={12}>
                  <label>Price of 7 days</label>
                  <Form.Item
                    name="day7"
                    rules={[
                      {
                        required: true,
                        message: "Please input your Price of 7 days!",
                      },
                    ]}
                  >
                    <Input placeholder="Price of 7 days" type="number" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <label>Price of +7 days</label>
